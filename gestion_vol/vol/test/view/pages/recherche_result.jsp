                ...
                <div class="col-md-4">
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      ...
                      <a href="update_redirect?id=<%= v.getId() %>" class="btn btn-primary">Modifier</a>
                      <a href="delete?id=<%= v.getId() %>" class="btn btn-primary">Supprimer</a>
                      <a href="annule?id=<%= v.getId() %>" class="btn btn-primary">Annuler</a>
                    </div>
                  </div>
                </div>
              </div>
