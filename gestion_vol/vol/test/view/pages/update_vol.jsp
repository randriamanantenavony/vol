              ...
              <div class="card">
                <div class="card-body">
                  <form action="update" method="post">
                    ...
                    <input type="hidden" value="<%= vol.getId() %>" name="id_vol"> 
                    <div class="mb-3">
                      <label for="exampleInputEmail1" class="form-label">Date et heure de depart : </label>
                      <input type="datetime-local" class="form-select" name="date1" value="<%= vol.getDateHeureDepart() %>">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="datetime-local" class="form-select" name="date2" value="<%= vol.getDateHeureArrivee() %>">
                   ...
                   %>
                     <div class="mb-3">
                         ...
                         <select id="avionSelect" class="form-select" name="avion">
                          <option value="<%= vol.getIdAvion().getId() %>"><%= vol.getIdAvion().getNom() %></option>  
               ...
               %>
                 <div class="mb-3">
                     ...
                     <select id="avionSelect" class="form-select" name="depart">
                      <option value="<%= vol.getVilleDepart().getId() %>"><%= vol.getVilleDepart().getNom() %></option>
                         <% for (Ville v : villes) { %>
                 ...
                 <div class="mb-3">
                  ...
                  <select id="arriveeSelect" class="form-select" name="arrivee">
                    <option value="<%= vol.getVilleArrivee().getId() %>"><%= vol.getVilleArrivee().getNom() %></option>
